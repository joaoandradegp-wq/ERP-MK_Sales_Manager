object Form9: TForm9
  ...
  Caption = 'EMPR'#201'STIMOS - CONSULTA GERAL'
  ClientHeight = 502
  ClientWidth = 698
  Color = clBtnFace
  ...
  object btn_baixa: TSpeedButton
    ...
    Glyph.Data = {
      ...
      
      A36B299B5B239852FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
  ...
  object comboconsult: TComboBox
    ...
    ItemHeight = 13
    TabOrder = 0
    OnChange = comboconsultChange
    OnEnter = comboconsultEnter
    Items.Strings = (
      'PANO'
      'MADEIRA'
      'FLOCOS'
  ...
  object ADOQuery1: TADOQuery
    ...
    object ADOQuery1calculo: TFloatField
  ...
  object ADOQuery2: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select filhas.nome, filhas.cpf from filhas '
      'INNER JOIN emprestimos ON'
      'filhas.cpf = emprestimos.cpf'
      'GROUP BY filhas.nome, filhas.cpf '
      '')
    Left = 600
    Top = 24
  ...
  object ADOQuery4: TADOQuery
    ...
    object ADOQuery4linha: TWideStringField
      FieldName = 'linha'
      Size = 100
    end
    ...
    object ADOQuery4sessao: TWideStringField
      FieldName = 'sessao'
      Size = 15
    end
    ...
    object ADOQuery4pontos: TWideStringField
      FieldName = 'pontos'
      Size = 50
    end
  ...
  object ADOQuery5: TADOQuery
    ...
    Left = 584
    Top = 416
    object ADOQuery5Cdigo: TAutoIncField
      FieldName = 'C'#243'digo'
      ReadOnly = True
    end
    ...
    object ADOQuery5cpf: TWideStringField
      FieldName = 'cpf'
      Size = 11
    end
